...
public class Avalibility {
    public Avalibility(Doctor doctor, LocalTime mon_startTime, LocalTime mon_endTime, LocalTime tue_startTime,
            LocalTime tue_endTime, LocalTime wed_startTime, LocalTime wed_endTime, LocalTime thu_startTime,
            LocalTime thu_endTime, LocalTime fri_startTime, LocalTime fri_endTime, LocalTime sat_startTime,
            LocalTime sat_endTime, LocalTime sun_startTime, LocalTime sun_endTime) {
        this.doctor = doctor;
    ...
    private Long avalibility_id;
    
    @OneToOne(mappedBy = "avalibility") 
    ...
    public Long getAvalibility_id() {
        return avalibility_id;
    }
    public void setAvalibility_id(Long avalibility_id) {
        this.avalibility_id = avalibility_id;
    }
